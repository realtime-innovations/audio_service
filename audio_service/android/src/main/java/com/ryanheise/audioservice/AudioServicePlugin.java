...
//        };
                ...
                switch (call.method) {
                    ...
                    case "androidForceEnableMediaButtons": {
                        ...
                        if (silenceAudioTrack == null) {
                            ...
                            /*     .build(); */
                            @SuppressWarnings("deprecation") final AudioTrack audioTrack = new AudioTrack(
        ...
        private static List<Map<?, ?>> mediaItems2raw
         ...
         */
        private static MediaDescriptionCompat addExtrasToMediaDescription (MediaDescriptionCompat
        description, Map < ?, ?>extras){
